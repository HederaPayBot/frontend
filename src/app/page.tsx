...
export default function Home() {
  ...
  const platformStyles = {
    web: {
      container:
        "bg-gradient-to-br from-gray-50 to-purple-50 rounded-lg shadow-md",
      header: "bg-purple-600 text-white",
      label: "Website Embed",
    },
    twitter: {
      container:
        "bg-gradient-to-br from-blue-50 to-sky-50 rounded-lg shadow-md",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Tweet a payment instruction mentioning{" "}
                <a
                  href="https://x.com/HederaPayBot"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="text-center p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                We securely process the payment on the Hedera network and
                confirm it for you.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="text-purple-600 text-2xl sm:text-3xl mb-3">
                🔄
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              HederaPayBot works directly with Twitter, allowing you to send
              cryptocurrency without leaving your favorite social platform.
            </p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-amber-800">
                    Twitter Widget Embedding Limitation
                  </h3>
                  <div className="mt-1 text-sm text-amber-700">
                    <p>
                      Due to Twitter's platform limitations, our widget cannot
                      be directly embedded within Twitter. All bot functionality
                      is fully working - you can interact with @HederaPayBot
                      through tweets and use the widget on your own website!
                    </p>
                    <p className="mt-2">
                      Follow our bot at{" "}
                      <a
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">
                Send Payments via Tweet
              </h3>
              <p className="text-sm sm:text-base text-gray-600">
                Simply mention @HederaPayBot with a command like "send 5 HBAR to
                @friend" - no need to leave Twitter.
              </p>
            </div>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="text-blue-500 text-2xl sm:text-3xl mb-3">🔒</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">
                Secure Twitter Authentication
              </h3>
              <p className="text-sm sm:text-base text-gray-600">
                Connect your Twitter account for secure, verified transactions
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Embed our widget on any website with automatic Twitter user
                detection for a seamless experience.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            <div className="space-y-6 order-2 lg:order-1">
              <div>
                ...
                <p className="text-sm sm:text-base md:text-lg mb-4 sm:mb-6 text-gray-600">
                  Add the HederaPayBot widget to your website to allow your
                  users to interact with the Hedera blockchain directly.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Copy-paste a single code snippet to integrate",
                  },
                  {
                    id: "customizable",
                    icon: "🎨",
                  ...
                  },
                  {
                    ...
                    desc: "Always running the latest version",
                  },
                ].map((feature) => (
                  <div
                    key={feature.id}
                  ...
                  >
                    <div className="flex items-start space-x-2 sm:space-x-3">
                      <div className="flex-shrink-0 text-purple-600 text-lg sm:text-xl">
                        {feature.icon}
                      </div>
                      <div>
            ...
            <div className="flex flex-col items-center order-1 lg:order-2">
              ...
              <div className="hidden md:flex items-center justify-center space-x-8 mb-8">
                ...
                >
                  <div
                    className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-2 
                    ${
                      widgetView === "web"
                  ...
                  <span
                    className={`text-xs sm:text-sm font-medium ${
                      widgetView === "web" ? "text-purple-600" : "text-gray-500"
                    }`}
                  >
                    Website
                  </span>
                ...
                >
                  ...
                  >
                    ...
                    <div className="bg-white rounded-md overflow-hidden">
                      ...
                      <div
                        className={`relative group transition-all duration-700 ease-in-out transform
                        ${
                        ...
                        {widgetView === "twitter" && (
                          <div className="absolute inset-0 bg-black/60 z-10 flex flex-col items-center justify-center text-white p-4">
                            ...
                            <h3 className="text-center font-bold mb-2">
                              Cannot Display on Twitter
                            </h3>
                            <p className="text-center text-sm opacity-90">
                              Due to Twitter's limitations, this widget cannot
                              be embedded directly on Twitter.
                            </p>
                            <p className="text-center text-xs mt-2 opacity-80">
                              Widget works perfectly on your own website!
                            </p>
                          </div>
                        )}
                  ...
                  {/* Floating badge */}
                  <div
                    className={`absolute -right-2 -top-2 px-2 py-1 rounded-full text-xs font-medium shadow-lg
                    ${
                      widgetView === "web"
                        ? "bg-purple-600 text-white"
                        : "bg-blue-500 text-white"
                  ...
                  <div
                    className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-4/5 h-4 
                    bg-gradient-to-b from-black/20 to-transparent rounded-full blur-md`}
                  ></div>
                </div>
              </div>
                  ...
                  <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 pb-1">
                    <pre className="text-xs md:text-sm whitespace-pre-wrap">
                      <code>
                        ...
                        <span className="text-yellow-400">"border:none;"</span>
                        <span className="text-green-400"> title</span>=
                        <span className="text-yellow-400">"HederaPayBot"</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Send cryptocurrency payments to Twitter users with simple
                commands.
              </p>
              <p>
                &copy; {new Date().getFullYear()} Hedera Twitter Pay. All rights
                reserved.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    href="https://github.com/yourusername/hedera-twitter-pay"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-white transition-colors"
                  >
